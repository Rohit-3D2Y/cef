      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-gray-600 font-normal">
            Our commitment to rigour, responsibility, and respect
          </p>
        </div>

        {/* Six Pillars Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-10 px-4">
          {pillars.map((pillar, index) => {
            ...
            return (
              ...
              >
                <div>
                  <h3 className="text-white font-semibold tracking-tight text-xl md:text-2xl mb-3 leading-tight">{pillar.title}</h3>
                  <p className="text-white/90 text-base md:text-lg leading-relaxed">{pillar.description}</p>
                </div>
